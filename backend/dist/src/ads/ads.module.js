...
const ads_queries_1 = require("./queries/ads.queries");
...
exports.AdsModule = AdsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [ads_service_1.AdsService, ads_queries_1.AdsQueries, ads_must_be_unique_validator_1.AdsMustBeUniqueValidator],
    })
], AdsModule);
